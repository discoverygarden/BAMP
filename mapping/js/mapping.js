Ext.onReady(function(){
    ...
    window.refreshMap = function(){
      //Get the map component and defined filters
      var bampMap = Ext.getCmp('bampMap');
      var aFilters = Ext.JSON.encode(window.mapFilters);

      var bampLoadingMask = new Ext.LoadMask(Ext.getCmp('mappingInterface'), {msg:"Searching for data. Please wait..."});
      var loadmaskshow = bampLoadingMask.show();
